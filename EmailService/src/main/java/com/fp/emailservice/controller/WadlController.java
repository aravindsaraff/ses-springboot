...
/**
 * Since spring rest does not have out of the box support for WADL generation, this solution mentioned in SO:
 * @see <a href="http://stackoverflow.com/questions/23271597/how-to-generate-wadl-for-spring-rest-service">How to Generate WADL</a>
 *
 */
...
public class WadlController {
    ...
    public @ResponseBody /*Application*/String generateWadl(HttpServletRequest request) {
        /*Application result = new Application();
        Doc doc = new Doc();
        doc.setTitle("Email Service WADL");
